...
class ColorGame:
    def __init__(self):
        ...
        self.scoreLabel = tkinter.Label(self.root, font=('Bakso Sapi', 30), bg="#DDEDEA")
...
def play_game():
    ...
    while True:
        ...
        loading_label = tkinter.Label(loading_window, text="Color Game akan segera dimulai:3", font=('Bakso Sapi', 40), bg="#DDEDEA")
        ...
        loading_window.after(0, start_game)
        loading_window.after(0, show_result)
